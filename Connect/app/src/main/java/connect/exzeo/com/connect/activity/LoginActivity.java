...
import connect.exzeo.com.connect.service.LocationService;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (EditText) findViewById(R.id.phone_number);
    ...
    /*public CurrentLocation getLocation() {
        ...
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (location != null) {
                ...
                System.out.println("============== login location lat ============ " + currentLocation.getLattitude());
                System.out.println("============== login location long ============ " + currentLocation.getLongitude());
